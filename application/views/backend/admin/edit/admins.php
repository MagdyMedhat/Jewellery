<!-- Begin of #main -->
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<div class="grid_12">
				<h1>Edit Admin</h1>
				<p>Here you can Edit the website administrators.</p>
			</div>
			
			<div class="grid_12">
				<div class="block-border">
					<div class="block-header">
						<h1>Edit Admin</h1><span></span>
					</div>
					<form id="validate-form" class="block-content form" action="<?echo base_url();?>backend/admin/edit_admin_done/{id}" method="post">
						<div class="_100">
